...
export default function PublicPayrollPage({ params }: PublicPayrollPageProps) {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        const month = normalizeMonth(resolvedParams.month);
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      pdf.save(`급여명세서_${employee.name}_${resolvedParams.month}.pdf`);
    } catch (err) {
      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="bg-white shadow rounded-lg p-6 mb-4">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600 mt-1">{resolvedParams.month} 급여</p>
            </div>
            <button
        ...
        <div id="payroll-statement-content" className="border border-gray-300 p-6 bg-white">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600">{resolvedParams.month} 급여</p>
          </div>
